...
def test_volume_filter_maximum(cell, maximum_volume_per_atom):
    filter = VolumeFilter(maximum_volume_per_atom=maximum_volume_per_atom)
    ...
    filter = VolumeFilter(maximum_volume_per_atom=volume)
...
def test_volume_filter_range(cell, a, b):
    ...
    filter = VolumeFilter(minimum_volume_per_atom=minimum,
                          maximum_volume_per_atom=maximum)
