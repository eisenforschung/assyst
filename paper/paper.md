...
`Claude <noreply@anthropic.com>`[@claude] or `github-bot[bot]`[@claude].
`jules` was used with Gemini 2.5 and 3, for `Claude` we used Sonnet and
Opus version 4.6 and 4.7. Prompts are linked in PR descriptions where
